...
const ComponentsDatatablesInProgressOrders = () => {
  ...
  const fetchRateeData = async () => {
    try {
      ...
      const inProgressOrders = formattedRate.filter(
        (order) => order.status === "in progress"
      );

      if (recordsDatasort == "dsc") {
        setInitialRecords(inProgressOrders.reverse());
      } else {
        setInitialRecords(inProgressOrders);
      }
...
export default ComponentsDatatablesInProgressOrders;
