...
const ComponentsDatatablesCompletedOrders = () => {
  ...
  const fetchRateeData = async () => {
    try {
      ...
      const completedOrders = formattedRate.filter(
        (order) => order.status === "Completed"
      );

      if (recordsDatasort == "dsc") {
        setInitialRecords(completedOrders.reverse());
      } else {
        setInitialRecords(completedOrders);
      }
...
export default ComponentsDatatablesCompletedOrders;
